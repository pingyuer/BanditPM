...
class MLflowLogger:
    ...
    def _cardia_metrics(cls, metrics: Mapping[str, Any]) -> dict[str, Any]:
        aliases = {
            ...
            "stage2/dynamic_anchor_minus_anchor_abs_mean": ("stage2_dynamic_anchor_minus_anchor_abs_mean", "cardia/stage2/dynamic_anchor_minus_anchor_abs_mean"),
            ...
            "boundary/edge_effective_mean": ("boundary_edge_effective_mean", "cardia/boundary/edge_effective_mean"),
