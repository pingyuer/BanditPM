...
run_exp echonet_gdkvm \
  ...
  wandb.tags='[echonet,gdkvm,kpff,gdr]'

run_exp echonet_bpm_rule \
  --config-name config_banditpm_baseline \
  ...
  wandb.group=echonet_baselines \
  wandb.tags='[echonet,bpm_rule,kpff,bpm]'
...
run_exp camus_kpff \
  ...
  wandb.tags='[camus,kpff,no_gdr]'

run_exp camus_bpm_rl \
  --config-name config_banditpm_baseline \
  exp_id=camus_bpm_rl \
  wandb_mode=online \
  dataset_name=camus \
  ...
  wandb.group=camus_baselines \
  wandb.tags='[camus,bpm_rl,kpff,bpm,rl]'
