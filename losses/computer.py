...
class LossComputer(nn.Module):
    def __init__(self, cfg: DictConfig, stage_cfg: DictConfig):
        ...
        self.lambda_geomaskformer_ranking = float(self.geomaskformer_loss_cfg.get("ranking", 0.1))
        self.lambda_geomaskformer_refinement = float(self.geomaskformer_loss_cfg.get("refinement", 0.1))
        self.lambda_geomaskformer_temporal = float(self.geomaskformer_loss_cfg.get("temporal", 0.03))
        self.lambda_geomaskformer_diversity = float(self.geomaskformer_loss_cfg.get("diversity", 0.01))
        self.geomaskformer_score_warmup_iters = int(self.geomaskformer_loss_cfg.get("score_warmup_iters", 300))
        self.geomaskformer_ranking_warmup_iters = int(self.geomaskformer_loss_cfg.get("ranking_warmup_iters", 500))
        self.geomaskformer_refinement_warmup_iters = int(self.geomaskformer_loss_cfg.get("refinement_warmup_iters", 500))
        self.geomaskformer_diversity_warmup_iters = int(self.geomaskformer_loss_cfg.get("diversity_warmup_iters", 300))
